...
public class GeneratedStatechart implements IStatemachine, ITimed, ICycleBased {
	...
	private static class GeneratedStatechartEvBuf {
	...
	private GeneratedStatechartEvBuf current = new GeneratedStatechartEvBuf();
	...
	*/
	...
	private void swapInEvents() {
		...
		onOff = false;
		current.iface.playPause = playPause;
		playPause = false;
	...
	*/
	...
	private long remoteControl_On_react(long transitioned_before) {
		...
		if (transitioned_after==transitioned_before) {
			...
			if (((current.iface.playPause) && (!getIsPlaying()))) {
				cD.raisePlay();
			}
			if (((current.iface.playPause) && (getIsPlaying()))) {
				cD.raisePause();
